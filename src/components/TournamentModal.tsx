...
export default function TournamentModal({ isOpen, onClose, tournament, onRegisterTeam }: TournamentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-start sm:items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-[24px] sm:rounded-[32px] w-full max-w-xl max-h-[92vh] flex flex-col shadow-2xl border border-brand-border/40 overflow-hidden relative my-auto">
